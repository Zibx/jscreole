 ...
 * npm module by zibx. zibx.mail@gmail.com
 */
var doc;
if(typeof document === 'undefined'){
    doc = (function(){
        ...
        Object.defineProperty(Node.prototype, 'innerHTML', {
            get: function () {
                ...
                return this.childNodes.map(function(node){
                    return node.type === 'TextNode' ? node.innerText : node.outerHTML;
                }).join('');
            },
            set: function (value) {
        ...
        Object.defineProperty(Node.prototype, 'outerHTML', {
            get: function () {
                var node = this, attrs = [], i;
                for( i in this.attrs )
                    attrs.push({name: i, val: i+'="'+this.getAttribute(i)+'"'});
                ...
                return noClose[node.type] ? '<'+node.type+(attrs.length?' '+attrs.join(' ')+'/':' /')+'>': '<'+node.type+(attrs.length?' '+attrs.join(' '):'')+'>'+node.innerHTML+'</'+node.type+'>';
            }
        });
...
var creole = function(options) {
    ...
    var g = {
        ...
        _highlight: { _regex: /!!([^!~]*((!(?!!)|!!!|~(.|(?=\n)|$))[^!~]*)*)(!!|\n|$)/,
            _build: function(node, r, options){
                ...
                var cls = ['highlight'],
                    maybeCls;
                r[1] = r[0].substr(2, r[0].length - 4);
                if(r[1].indexOf('!!!')>-1){
                    maybeCls = r[1].split('!!!');
                    cls.push(maybeCls[0]);
                    r[1] = maybeCls.slice(1).join('!!!');
                }
                span.setAttribute('class', cls.join(' '));
                span.innerHTML = r[1];
    ...
    g._unnamedUri._build = g._rawUri._build = function(node, r, options) {
        ...
        g._namedUri._build.call(this, node, [r[0], r[1], r[1]], options);
    };
    g._unnamedLink._build = function(node, r, options) {
        g._namedLink._build.call(this, node, [r[0], r[1], r[1]], options);
    };
    ...
    g._unnamedInterwikiLink._build = function(node, r, options) {
        g._namedInterwikiLink._build.call(this, node, [r[0], r[1], r[1]], options);
    };
    ...
    g.h1._children = g.h2._children = g.h3._children =
            ...
            g._text._children = g._strong._children = g._highlight._children = g._em._children = g._underline._children =
        [ g._escapedSequence, g._strong, g._highlight, g._underline, g._em, g._br, g._rawUri,
